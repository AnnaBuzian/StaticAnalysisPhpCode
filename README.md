# StaticAnalysisPhpCode

For an easy access to the most popular static analysis tools for PHP I recently created a docker image - [phpqa](https://github.com/jakzal/phpqa).
